...
extension ContextExt on BuildContext {
  ...
  ScrollBehavior get scrollConfiguration => ScrollConfiguration.of(this);
  ...
  void showSnackBar(Widget snackBar, {int seconds = 5}) {
...
extension ScaffolMessengerExt on GlobalKey<ScaffoldMessengerState> {
  void showSnackBarFromCurrentState(Widget snackBar, {int seconds = 5}) {
